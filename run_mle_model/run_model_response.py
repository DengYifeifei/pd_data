...
if __name__ == "__main__":
    ...
    # ---- Predictor sets ----
    model_preds = {
        "1": ["learning_surprise_bi", "learning_surprise_cued", "cue_learning_surprise"]
    }

    # ---- Dependent variables ----
    dvs = [
        "max_pupilResponse_Ratio",
        # "mean_pupilResponse_Ratio",
        # "median_pupilResponse_Ratio"
    ]
